...
export default function CrearUsuariPage() {
    ...
    const validateForm = (): string | null => {
        ...
        if (!formData.password) return 'La contrasenya és obligatòria'
        if (formData.password.length < 8) return 'La contrasenya ha de tenir mínim 8 caràcters'
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch('/api/admin/usuaris', {
                method: 'POST',
            ...
            if (!response.ok) {
                ...
                throw new Error(data.error || 'Error creant usuari')
            }
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-xl p-8 text-center">
                        ...
                        <p className="text-green-700">
                            {formData.sendWelcomeEmail
                                ? `S'ha enviat un correu de benvinguda a ${formData.email}`
                                : 'L\'usuari ja pot accedir al sistema'
                            }
                        </p>
                    </div>
                </div>
            ...
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-semibold text-slate-900">Crear nou usuari</h1>
                            <p className="text-sm text-slate-500">Afegeix un nou usuari al sistema</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="space-y-4">
                            <label className="flex items-center gap-3 cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500">L'usuari podrà accedir immediatament</p>
                                </div>
                            </label>
                            ...
                            <label className="flex items-center gap-3 cursor-pointer">
                                ...
                                />
                                <div>
                                    <p className="font-medium text-slate-900">Enviar email de benvinguda</p>
                                    <p className="text-sm text-slate-500">L'usuari rebrà les credencials per email</p>
                                </div>
                            </label>
                        </div>
                    </div>
