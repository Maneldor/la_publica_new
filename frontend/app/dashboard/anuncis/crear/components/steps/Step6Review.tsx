...
export const Step6Review = ({ formData, errors, onPublish, isPublishing = false }: Step6ReviewProps) => {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="space-y-3 text-sm">
            {formData.contactName || formData.contactPhone || formData.contactEmail || formData.contactSchedule ? (
              <>
                ...
                {formData.contactSchedule && (
                  <div className="pt-3 border-t">
                    <span className="text-gray-600 block mb-1">Horari preferit:</span>
              ...
              <div className="text-center py-4">
                ...
                <p className="text-gray-600 text-sm">
                  Els interessats podran contactar via missatge intern
                </p>
              </div>
            )}
          </div>
