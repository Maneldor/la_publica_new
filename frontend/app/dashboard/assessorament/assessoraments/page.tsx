...
const sampleAssessments = [
  ...
  {
    id: 2,
    title: 'Consulta Tributària per a Funcionaris',
    description: 'Assessorament fiscal especialitzat en deduccions i beneficis fiscals per a empleats públics.',
    company: {
      id: 4,
  ...
  {
    id: 3,
    title: 'Assessorament en Transformació Digital',
    description: 'Consulta gratuïta sobre digitalització de processos i implementació de noves tecnologies.',
    company: {
      id: 1,
  ...
  {
    id: 4,
    title: 'Consulta Laboral i Recursos Humans',
    description: 'Assessorament en dret laboral, convenis col·lectius i gestió de recursos humans.',
    company: {
      id: 5,
      name: 'RH Consultors Associats',
...
export default function AssessoramentsPage() {
