...
import { Target, Plus, ChevronRight, UserPlus, Users, MoreVertical } from 'lucide-react'
...
export default function LeadsPage() {
  ...
  const canAssignLeads = session?.user?.role &&
    ['CRM_COMERCIAL', 'ADMIN', 'ADMIN_GESTIO', 'SUPER_ADMIN'].includes(session.user.role)
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              <option value="CONSTRUCTION">Construcció</option>
              <option value="FINANCE">Finances</option>
              <option value="HEALTHCARE">Salut</option>
              <option value="EDUCATION">Educació</option>
            </select>
          </div>
        </div>
      </div>
                    ...
                    >
                      ...
                      >
                        <div>
                          ...
                          {lead.sector && <div className="text-xs text-slate-500">{lead.sector}</div>}
                        </div>
                      </td>
                      <td
                        className="px-6 py-4 cursor-pointer"
