...
import { FileText, Link as LinkIcon, Sparkles, Info } from 'lucide-react'
import { ImageUploader } from './ImageUploader'
import { AdPreview } from './AdPreview'
import { SchedulingSection } from './SchedulingSection'

interface StepDetailsLaPublicaProps {
...
export function StepDetailsLaPublica({
  formData,
  onChange,
  pricing,
  errors
}: StepDetailsLaPublicaProps) {
  ...
  const handleSchedulingChange = (scheduling: AdvancedScheduling) => {
    onChange({
      scheduling,
      // Mantener sincronizados los campos básicos para compatibilidad
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Detalls de l'anunci intern</h2>
          <p className="text-gray-500">Anunci de La Pública - sense facturació</p>
        </div>
        <button
          type="button"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Notes visibles només per l'equip de gestió"
                  rows={2}
