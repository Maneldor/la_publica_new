...
export function CompanySearchFilters({ onSearch, onFilterChange, totalResults, availableCategories }: CompanySearchFiltersProps) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <input
            type="text"
            placeholder="Buscar empreses per nom, sector o descripció..."
            value={searchTerm}
      ...
      {showFilters && (
        <div style={{
          ...
          <div style={{
            ...
            {/* Filtre per tipus de col·laboració */}
            <div>
              <label style={{
                display: 'block',
                fontSize: '12px',
              ...
              >
                ...
                <option value="partner">Partner tecnològic</option>
                <option value="proveidor">Proveïdora</option>
