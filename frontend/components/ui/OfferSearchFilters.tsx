    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <input
            type="text"
            placeholder="Buscar ofertes per títol, empresa o categoria..."
            value={searchTerm}
          ...
          <div style={{
            ...
            <div>
              ...
              >
                ...
                <option value="50-100">Més del 50%</option>
                <option value="100">Gratuït</option>
              </select>
            </div>
            ...
            <div>
              ...
              >
                ...
                <option value="Formació Professional Plus">Formació Professional Plus</option>
