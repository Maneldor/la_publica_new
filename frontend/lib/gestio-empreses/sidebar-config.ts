...
export const SIDEBAR_CONFIG: SidebarSection[] = [
  ...
  // ============================================
  {
    ...
    items: [
      ...
      {
        id: 'generar-pressupostos',
        label: 'Generar Pressupost',
        href: '/gestio/admin/generar_pressupostos',
        icon: Sparkles,
        roles: [...ROLE_GROUPS.ADMINS],
      },
      {
      ...
      {
        id: 'empreses-collaboradores',
        label: 'Empreses Col·laboradores',
        href: '/gestio/admin/empreses-collaboradores',
        icon: Building2,
        roles: [...ROLE_GROUPS.ADMINS],
      },
      {
  ...
  // ============================================
  {
    ...
    items: [
      ...
      {
        id: 'empreses-canvis',
        label: 'Canvis Pendents',
        href: '/gestio/empreses/canvis-pendents',
        icon: AlertTriangle,
        roles: [...ROLE_GROUPS.ADMINS, 'CRM_COMERCIAL'] as UserRole[],
      },
    ],
  },
