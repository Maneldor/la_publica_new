...
export const ROLE_GROUPS = {
  ...
  CAN_VIEW_ALL_COMMERCIAL: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],

  // Poden verificar leads/empreses
  CAN_VERIFY: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],

  // Poden assignar leads/empreses
  CAN_ASSIGN: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],

  // Poden gestionar equip
  CAN_MANAGE_TEAM: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
}
...
export const PERMISSIONS = {
  // LEADS
  LEADS_VIEW_ALL: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  LEADS_VIEW_OWN: ['GESTOR_ESTANDARD', 'GESTOR_ESTRATEGIC', 'GESTOR_ENTERPRISE'] as UserRole[],
  LEADS_CREATE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL', 'GESTOR_ESTANDARD', 'GESTOR_ESTRATEGIC', 'GESTOR_ENTERPRISE'] as UserRole[],
  LEADS_EDIT: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL', 'GESTOR_ESTANDARD', 'GESTOR_ESTRATEGIC', 'GESTOR_ENTERPRISE'] as UserRole[],
  LEADS_DELETE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  LEADS_VERIFY: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  LEADS_ASSIGN: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  LEADS_AI_GENERATE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL', 'GESTOR_ESTANDARD', 'GESTOR_ESTRATEGIC', 'GESTOR_ENTERPRISE'] as UserRole[],
  LEADS_EXPORT: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],

  // EMPRESES
  COMPANIES_VIEW_ALL: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  COMPANIES_VIEW_OWN: ['GESTOR_ESTANDARD', 'GESTOR_ESTRATEGIC', 'GESTOR_ENTERPRISE'] as UserRole[],
  COMPANIES_CREATE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  COMPANIES_EDIT: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL', 'GESTOR_ESTANDARD', 'GESTOR_ESTRATEGIC', 'GESTOR_ENTERPRISE'] as UserRole[],
  COMPANIES_DELETE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO'] as UserRole[],
  COMPANIES_ASSIGN: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  COMPANIES_VERIFY: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  COMPANIES_PUBLISH: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],

  // OFERTES
  OFFERS_VIEW_ALL: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  OFFERS_VIEW_OWN: ['GESTOR_ESTANDARD', 'GESTOR_ESTRATEGIC', 'GESTOR_ENTERPRISE'] as UserRole[],
  OFFERS_CREATE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL', 'GESTOR_ESTANDARD', 'GESTOR_ESTRATEGIC', 'GESTOR_ENTERPRISE'] as UserRole[],
  OFFERS_EDIT: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL', 'GESTOR_ESTANDARD', 'GESTOR_ESTRATEGIC', 'GESTOR_ENTERPRISE'] as UserRole[],
  OFFERS_DELETE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  OFFERS_PUBLISH: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],

  // EQUIP
  TEAM_VIEW: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  TEAM_MANAGE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],

  // VERIFICACIÓ
  VERIFICATION_ACCESS: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],

  // ASSIGNACIONS
  ASSIGNMENTS_ACCESS: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],

  // ESTADÍSTIQUES
  STATS_VIEW_ALL: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO'] as UserRole[],
  ...
  // CONTINGUT (per ADMIN_GESTIO + CRM_CONTINGUT)
  CONTENT_VIEW_ALL: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_CONTINGUT'] as UserRole[],
  CONTENT_CREATE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_CONTINGUT'] as UserRole[],
  CONTENT_EDIT: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_CONTINGUT'] as UserRole[],
  CONTENT_DELETE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_CONTINGUT'] as UserRole[],
  CONTENT_PUBLISH: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_CONTINGUT'] as UserRole[],
  CONTENT_MODERATE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_CONTINGUT', 'MODERATOR'] as UserRole[],

  // TASQUES / AGENDA (filtre propi)
  TASKS_VIEW_ALL: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO'] as UserRole[],
  ...
  // MISSATGERIA
  MESSAGES_VIEW_ALL: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO'] as UserRole[],
  ...
  BILLING_VIEW: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'] as UserRole[],
  BILLING_MANAGE: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO'] as UserRole[],

  // CONFIGURACIÓ
  SETTINGS_VIEW: ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO'] as UserRole[],
  SETTINGS_EDIT: ['SUPER_ADMIN', 'ADMIN'] as UserRole[],
}
...
export function canSwitchView(role: UserRole | undefined | null): boolean {
  if (!role) return false
  return ['SUPER_ADMIN', 'ADMIN', 'ADMIN_GESTIO', 'CRM_COMERCIAL'].includes(role)
}
