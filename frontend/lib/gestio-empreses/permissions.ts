...
export const PERMISSIONS = {
  ...
  CONTENT_VIEW_ALL: ['ADMIN_GESTIO', 'CRM_CONTINGUT'] as UserRole[],
  CONTENT_CREATE: ['ADMIN_GESTIO', 'CRM_CONTINGUT'] as UserRole[],
  CONTENT_EDIT: ['ADMIN_GESTIO', 'CRM_CONTINGUT'] as UserRole[],
  CONTENT_DELETE: ['ADMIN_GESTIO', 'CRM_CONTINGUT'] as UserRole[],
  CONTENT_PUBLISH: ['ADMIN_GESTIO', 'CRM_CONTINGUT'] as UserRole[],
  CONTENT_MODERATE: ['ADMIN_GESTIO', 'CRM_CONTINGUT', 'MODERATOR'] as UserRole[],
